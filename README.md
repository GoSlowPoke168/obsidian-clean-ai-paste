...
\- \*\*Unbolds Headers:\*\* Automatically detects Markdown headers (e.g., `### Header`) and strips out asterisks (`\*\*`) or underscores (`\_\_`), while leaving bold text in your standard paragraphs intact.
...
While waiting for approval in the official Obsidian Community Plugins directory, you can install this manually:
